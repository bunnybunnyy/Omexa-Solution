...
const projects = [
  {
    ...
    image: "https://i.postimg.cc/5tXnhcyq/Gemini-Generated-Image-msaec4msaec4msae.png",
    icon: Code,
    color: "blue",
  ...
  },
  {
    ...
    image: "https://i.postimg.cc/0yMSx9Gw/Gemini-Generated-Image-eehfhveehfhveehf.png",
    icon: ShoppingCart,
    color: "green",
  ...
  },
  {
    ...
    image: "https://i.postimg.cc/MZ1xCNjZ/Gemini-Generated-Image-vzinb8vzinb8vzin.png",
    icon: Code,
    color: "green",
  ...
  },
  {
    ...
    category: "Web Application",
    description: "Scalable Flight Application for Android & IOS with modern UI/UX",
    image: "https://i.postimg.cc/nhy3fRD3/Emirates-Ui-page-0001-Copy.jpg",
    icon: Palette,
    color: "green",
    tags: [ "Figma", "Payment"," Photoshop"],
  },
  {
    title: "Suzuki Showroom",
    category: "Web Application",
    description: "Scalable Suzuki Showroom for Android & IOS with modern UI/UX",
    image: "https://i.postimg.cc/nrND95pr/Mac-Book-Air-1-Copy.png",
    icon: Palette,
    color: "green",
    tags: [ "Figma", "Payment"," Photoshop"],
  },
  {
    ...
    image: "https://i.postimg.cc/59Qqbqxd/Gemini-Generated-Image-8asewm8asewm8ase.png",
    icon: ShoppingCart,
    color: "green",
